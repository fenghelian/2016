...
Assessment: Read in the data [here]("https://raw.githubusercontent.com/datasciencelabs/2016_data/master/bio260_heights.csv"). Use the `filter` function to determine how many males and females we have.

dim(filter(dat, dat$gender=="Female"))
dim(filter(dat, dat$gender=="Male"))
...
Assessment: Use the normal approximation to determine what proportion of US men are as tall as Michael Jordan?6'6=78 
```{r}
1-pnorm(78,mu,sigma)
```
...
Assessment: In the US, how many time more 6'6 men are there than 7 footers?
```{r}
(1-pnorm(84,mu,sigma))/(1-pnorm(78,sigma))
```



Assessment:  What proportion of 7 footers are in the NBA? Hint: There are 36 7 footers in the NBA. Hint 2: The average height of men 18-35 is  68.5 and SD 3 inches and is approximately normal? total :1.25 bilion 
